import { c as createAstro, d as createComponent, r as renderTemplate, m as maybeRenderHead, e as addAttribute, s as spreadAttributes, f as renderComponent, h as renderSlot } from '../astro_BIQwAA1w.mjs';
import 'kleur/colors';
import { g as getFormattedDate, a as getAllPosts, b as getUniqueTagsWithCount, $ as $$Button, c as $$BaseLayout, d as cn, s as sortMDByDate } from './404_DSfIcz0S.mjs';
import 'clsx';
import { $ as $$Image } from './generic_Bbg-7exE.mjs';

const $$Astro$8 = createAstro("https://jimmi.is");
...
}, "/Users/Jimmi/resume/src/components/FormattedDate.astro", void 0);

const $$Astro$7 = createAstro("https://jimmi.is");
...
}, "/Users/Jimmi/resume/src/components/blog/PostPreview.astro", void 0);
...
}, "/Users/Jimmi/resume/src/components/Section.astro", void 0);
...
const $$Card = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const images = /* #__PURE__ */ Object.assign({"/src/assets/about-astro.png": () => Promise.resolve().then(() => aboutAstro),"/src/assets/coming-soon.png": () => import('../coming-soon_C9q2g2C0.mjs')});
  if (!images[imagePath])
  ...
  ), "href": href }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Image", $$Image, { "src": images[imagePath](), "alt": altText, "class": cn("mb-3 md:absolute md:mb-0", imageClass), "loading": "eager" })} ${maybeRenderHead()}<div class="flex flex-col gap-y-1.5"> <div class="flex flex-col gap-y-0.5"> <h1 class="text-lg font-medium">${heading}</h1> <h2 class="text-muted-foreground">${subheading}</h2> <h2 class="text-muted-foreground">${date}</h2> </div> ${renderSlot($$result2, $$slots["default"])} </div> ` })}`;
}, "/Users/Jimmi/resume/src/components/Card.astro", void 0);
...
}, "/Users/Jimmi/resume/src/components/ProjectCard.astro", void 0);
...
}, "/Users/Jimmi/resume/src/components/Label.astro", void 0);
...
}, "/Users/Jimmi/resume/src/components/SkillLayout.astro", void 0);
...
const astro = new Proxy({"src":"/_astro/about-astro.0znnbM0P.png","width":249,"height":450,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/Users/Jimmi/resume/src/assets/about-astro.png";
							}
...
export { $$FormattedDate as $, $$PostPreview as a, index as b, index$1 as i };
